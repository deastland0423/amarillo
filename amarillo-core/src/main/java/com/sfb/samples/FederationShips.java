...
public class FederationShips {
    ...
    public static Map<String, Object> getFedCa() {
        ...
        p1.setArcs(ArcUtils.FH);
        p1.setDesignator("1");
        weapons.add(p1);
        Phaser1 p2 = new Phaser1();
        p2.setArcs(ArcUtils.FH);
        p2.setDesignator("2");
        weapons.add(p2);
    ...
    /** Federation New Light Cruiser — Kearsarge Class (e.g. USS Kearsarge) */
    public static Map<String, Object> getFedNcl() {
        Map<String, Object> s = new HashMap<>();
    ...
    public static Map<String, Object> getFedOcl() {
        ...
        weapons.add(p1);
        Phaser1 p2 = new Phaser1();
        p2.setArcs(ArcUtils.RS);
        p2.setDesignator("2");
        weapons.add(p2);
        Phaser1 p3 = new Phaser1();
        p3.setArcs(ArcUtils.LS);
        p3.setDesignator("3");
        weapons.add(p3);
