 ...
 *
 * Standard drones (TypeI, TypeIV) keep 3-turn (96 impulse) endurance at any speed tier.
 * Transitional speed-12 drones (TypeII, TypeV) have 2-turn (64 impulse) endurance and
 * become obsolete once medium-speed (TypeIM/TypeIVM) drones arrive in Y165.
 *
 * Speed tiers: Slow=8 (always), Moderate=12 (always), Medium=20 (Y165+), Fast=32 (Y178+).
 * Naming convention for upgrades: base name + M (medium) or F (fast), e.g. TypeIM, TypeIVF.
 */
public enum DroneType {
  ...
  TypeII (64, 12,  12, 1.0, 4, false,   0),  // TypeI boosted to speed 12
  TypeV  (64, 12,  24, 2.0, 6, false,   0),  // TypeIV boosted to speed 12
