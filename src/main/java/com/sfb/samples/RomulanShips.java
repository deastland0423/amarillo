...
public class RomulanShips {
    ...
    public static Map<String, Object> getRomKr() {
        ...
        s.put("shield4", 13); s.put("shield5", 15); s.put("shield6", 22);

        s.put("fhull", 5); s.put("ahull", 7);

        s.put("lwarp", 15); s.put("rwarp", 15); s.put("impulse", 4);
        s.put("apr", 3); s.put("battery", 4);
        ...
        s.put("crew", 40); s.put("boardingparties", 10); s.put("minimumcrew", 4);
        ...
        Phaser1 p1 = new Phaser1(); p1.setArcs(fxAftArc); p1.setDesignator("1"); weapons.add(p1);
        Phaser1 p2 = new Phaser1(); p2.setArcs(fxAftArc); p2.setDesignator("2"); weapons.add(p2);
        Phaser1 p3 = new Phaser1(); p3.setArcs(fxAftArc); p3.setDesignator("3"); weapons.add(p3);
